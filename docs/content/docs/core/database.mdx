---
title: Database
description: GORM initialization, connection pooling, generic CRUD service, base model, and versioned SQL migrations.
---

The `database` package provides everything required to persist data in Mannaiah: a GORM connection
factory, a shared base model, a generic CRUD service, and a versioned migration runner.
