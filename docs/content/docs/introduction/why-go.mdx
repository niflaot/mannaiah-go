---
title: Why Go?
description: The reasoning behind selecting Go as the implementation language for Mannaiah.
---
...
without memory pressure. The `sync` and `context` packages provide coordination without third-party dependencies.
