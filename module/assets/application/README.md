...
- Methods: `NewService(repository, storage, publishers...)`, `(*AssetService).Create`, `(*AssetService).Get`, `(*AssetService).List`, `(*AssetService).Update`, `(*AssetService).Delete`, `(*AssetService).Exists`, `(*AssetService).RunJPGWorker`, `(*AssetService).CreateFolder`, `(*AssetService).GetFolder`, `(*AssetService).ListFolders`, `(*AssetService).GetFolderTree`, `(*AssetService).UpdateFolder`, `(*AssetService).DeleteFolder`
