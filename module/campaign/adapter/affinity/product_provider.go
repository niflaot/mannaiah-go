...
func (p *ProductProvider) GetProducts(ctx context.Context, contactID string, block campaigndomain.ProductBlock) ([]campaigndomain.TemplateProduct, error) {
	query := domain.RecommendationQuery{
		...
		ExcludeCategoryIDs:       block.ExcludeCategoryIDs,
		IncludeTags:              block.IncludeTags,
		ExcludeTags:              block.ExcludeTags,
		MinPrice:                 block.MinPrice,
		MaxPrice:                 block.MaxPrice,
		ExcludePurchasedProducts: block.ExcludePurchasedProducts,
