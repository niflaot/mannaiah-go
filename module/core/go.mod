...
require (
	...
	mannaiah/module/analytics v0.0.0
	...
	mannaiah/module/storefront v0.0.0
...
replace mannaiah/module/membership => ../membership

replace mannaiah/module/syncrecord => ../syncrecord

replace mannaiah/module/analytics => ../analytics

replace mannaiah/module/segment => ../segment
...
replace mannaiah/module/storefront => ../storefront
