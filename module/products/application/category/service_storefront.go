...
type StorefrontNavigationRefresher interface {
	// TriggerRefresh requests a fail-open storefront navigation refresh after category mutations.
	TriggerRefresh(ctx context.Context)
}

// SetStorefrontNavigationRefresher configures storefront navigation refresh dependencies.
func (s *CategoryService) SetStorefrontNavigationRefresher(refresher StorefrontNavigationRefresher) {
	if s == nil {
		return
	}
...
func (s *CategoryService) triggerStorefrontNavigationRefresh(ctx context.Context) {
