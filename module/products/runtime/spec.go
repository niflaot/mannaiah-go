...
func OpenAPISpec() *openapi3.T {
	...
	components.Schemas = openapi3.Schemas{
		...
		"StorefrontNavigation":       &openapi3.SchemaRef{Value: storefrontNavigationSchema()},
		"StorefrontCategoryNode":     &openapi3.SchemaRef{Value: storefrontCategoryNodeSchema()},
		"StorefrontProductNode":      &openapi3.SchemaRef{Value: storefrontProductNodeSchema()},
		"StorefrontStaticPageNode":   &openapi3.SchemaRef{Value: storefrontStaticPageNodeSchema()},
	...
	return &openapi3.T{
		...
		Paths: openapi3.NewPaths(
			...
			openapi3.WithPath("/storefront/navigation", storefrontNavigationPathItem()),
		...
		Tags: openapi3.Tags{
			...
			&openapi3.Tag{Name: storefrontTag},
