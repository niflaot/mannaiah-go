...
// markRotulusDocumentOperation defines the OpenAPI operation for per-mark rotulus documents.
func markRotulusDocumentOperation() *openapi3.Operation {
	return &openapi3.Operation{
		OperationID: "ShippingController_getMarkRotulusDocument",
		Summary:     "Get mark rotulus PDF document",
		Tags:        []string{shippingTag},
		Security:    bearerSecurityRequirements(),
		Parameters: openapi3.Parameters{
			pathStringParameter("id", "Shipping mark identifier."),
		...
		Responses: openapi3.NewResponses(
			openapi3.WithStatus(200, binaryPDFResponse("Rotulus PDF document.")),
