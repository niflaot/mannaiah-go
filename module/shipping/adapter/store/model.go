...
type shippingMarkModel struct {
	...
	CollectOnDeliveryAmount        float64                 `gorm:"column:collect_on_delivery_amount;type:decimal(15,2)"`
	CollectOnDeliveryFeePercent    float64                 `gorm:"column:collect_on_delivery_fee_percent;type:decimal(5,2)"`
...
type quotationModel struct {
	...
	CollectOnDeliveryFeeAmount float64              `gorm:"column:collect_on_delivery_fee_amount;type:decimal(15,2);default:0"`
